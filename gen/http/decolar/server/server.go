...
// New instantiates HTTP handlers for all the decolar service endpoints using
...
func (s *Server) Service() string { return "decolar" }
...
// NewCreatePaisHandler creates a HTTP handler which loads the HTTP request and
// calls the "decolar" service "create_pais" endpoint.
func NewCreatePaisHandler(
	...
	var (
		decodeRequest  = DecodeCreatePaisRequest(mux, decoder)
		encodeResponse = EncodeCreatePaisResponse(encoder)
		encodeError    = EncodeCreatePaisError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "create_pais")
...
// NewCreateCompaniaHandler creates a HTTP handler which loads the HTTP request
// and calls the "decolar" service "create_compania" endpoint.
func NewCreateCompaniaHandler(
	endpoint endpoint.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeCreateCompaniaRequest(mux, decoder)
		encodeResponse = EncodeCreateCompaniaResponse(encoder)
		encodeError    = EncodeCreateCompaniaError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
